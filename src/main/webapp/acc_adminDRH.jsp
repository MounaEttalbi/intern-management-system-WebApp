		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="acc_adminDRH.jsp">My account</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
...
<section>
    <div class="content-container">
        <aside class="dashboard">
            ...
            <ul>
                <li><a href="getstagiaire">Gérer les Stagiaires</a></li>
                <li><a href="getStage">Gérer les Stages</a></li>
        ...
        <main class="description">
            <h2>Bienvenue, Administrateur DRH</h2>
            <p>
