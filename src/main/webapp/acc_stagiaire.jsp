		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="acc_stagiaire.jsp">My account</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
...
<section>
    <div class="content-container">
        <aside class="dashboard">
            ...
            <ul>
                <li><a href="infoStagiaire.jsp">Mes informations</a></li>
        ...
        <main class="description">
            <h2>Bienvenue Cher Stagiaire</h2>
            <p>
