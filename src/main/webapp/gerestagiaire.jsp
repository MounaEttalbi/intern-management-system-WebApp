...
<section>
    <div class="content-container">
        <aside class="dashboard">
            ...
            <ul>
                <li><a style="color:#000000" href="getstagiaire">Gerer les Stagiaires</a></li>
                <li><a href="getStage">Gerer les Stages</a></li>
        ...
        <main class="description">
            <div class="container">
    <form method="get" action="deleteStagiaire" class="border">
    ...
    <c:set var="filiere" value="${element.filiere}"/>
    
    <c:set var="etablissement" value="${element.etablissement}"/>
        <tbody>
          <tr>
            ...
            <td><c:out value="${dateN}"/></td>
             <td><c:out value="${filiere}"/></td>
               <td><c:out value="${etablissement}"/></td>
     ...
     <button name="ajouter"  class="btn btn-danger"><a style="color: #000000" href="registration.jsp" class="signup-image-link">add compte</a></button>
    </div>
        </main>
    </div>
</section>
